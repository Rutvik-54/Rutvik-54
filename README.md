...
🚀 A tech enthusiast shaping the web from both ends — frontend to backend.  
🎯 Passionate about building seamless digital experiences that **look great** and **work flawlessly**.  
🎨 UI/UX nerd — crafting interfaces that feel alive.  
🧠 Backend thinker — logic, scalability, and clean APIs are my playground.  
💻 Fluent in **HTML, CSS, JavaScript, Python**, and more.  
